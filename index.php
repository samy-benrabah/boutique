    ...
    <header>
        <div>
            ...
            <ul>
                ...
                <li><a href="../boutique_en_ligne/Assets/HTML/shop.php">Nos Produits</a></li>
        ...
        <ul class="price">
            ...
            <li>
                <a href="../boutique_en_ligne/Assets/HTML/connexion.php"><img src="Assets/Images/user.svg" alt="cart-photo"></a>(Login)
            </li>
        </ul>
    </header>
    <main>
